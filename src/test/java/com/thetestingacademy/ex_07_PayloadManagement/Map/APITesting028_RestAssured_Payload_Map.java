...
//                "}";
        ...
        jsonBodyUsingMap.put("firstname","Meeti");
        jsonBodyUsingMap.put("lastname", "Jha");
        ...
        validatableResponse.body("booking.firstname", Matchers.equalTo("Meeti"));
        validatableResponse.body("booking.lastname", Matchers.equalTo("Jha"));
